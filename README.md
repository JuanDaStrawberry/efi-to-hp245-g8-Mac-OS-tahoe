...
Installation guide: Install macOS with Secure Boot disabled, as it comes with this EFI. PLEASE INSTALL WITHOUT INTERNET CONNECTION. During the initial macOS setup, create a local account; do not log in to your iCloud account. This will display the File Vault tab. DO NOT ACTIVATE FILE VAULT (it's very problematic to activate it).
